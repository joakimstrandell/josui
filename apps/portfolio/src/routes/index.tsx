      ...
      <div className="relative flex min-h-[calc(100vh-60px)] flex-col">
        ...
        >
          <AnimateContent
            ...
            className="pointer-events-auto -mr-24"
          >
            <StackedPanes />
          </AnimateContent>
        </div>
        ...
        <PageSection className="relative z-10 max-w-6xl pt-48">
            ...
            <div className="prose prose-xl md:prose-2xl prose-a mx-auto text-center">
              <h2 className="mb-4">
                ...
                <RotatingText
                  ...
                  words={["Succeed", "Scale", "Innovate", "Ship", "Launch"]}
                />
              </h2>
              <p className="mx-auto max-w-[52ch]">
                I adapt quickly to your team&apos;s needs and can parachute into any stage of
                development, or execute across the entire product lifecycle.
              </p>
            </div>
          </AnimateContent>
          {/* Product Design */}
          <div className="mt-12 space-y-8 md:mt-24 md:space-y-12">
            <AnimateContent animationType="slideUp">
              <Card
                shadow="none"
                className="border-border/40 flex flex-col items-center border p-0 md:flex-row"
              >
