      ...
      <PageSection width="narrow">
        <AnimateContent className="prose">
          ...
          <p className="text-muted-foreground">
            ...
            <br />
            <strong>Outcome:</strong> Evolving design system architecture with multi-framework
            delivery
            <br />
          </p>
        </AnimateContent>
        <AnimateContent className="prose">
          ...
          <p>
            ...
            scalable UI architecture and platform-ready tooling. It is actively evolving as I test
            ideas, refine patterns, and ship new packages.
          </p>
          <p>
            The system currently includes tokens, core logic, web utilities, and framework-specific
            libraries for both React and Vue, with shared tooling to keep consistency across
            packages.
          </p>
          <p>
            The goal is to show end-to-end thinking: design tokens as the source of truth, a layered
            architecture that keeps responsibilities clean, and delivery formats that match how
            teams actually consume design systems.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="prose">
          ...
          <p>
            ...
            surfaces consistent and reducing duplication between packages.
          </p>
          <Checklist
            className="my-4"
            items={[
        ...
        <AnimateContent className="prose">
          ...
          <p>
            ...
            implementations, with separate styling delivery channels. The token pipeline is the
            single source of truth and feeds every consumer package as the system grows.
          </p>
          <Checklist
            className="my-4"
            items={[
        ...
        <AnimateContent className="prose">
          ...
          <p>
            ...
            <br />
            Tokens live as JSON files and are compiled into JS, CSS variables, Tailwind tokens, and
            SCSS outputs using Terrazzo. The pipeline is evolving as new formats and naming
            conventions are tested.
          </p>
          <p>
            <strong>Core and web utilities</strong>
            <br />
            Core behavior is centralized in @josui/core, with web-specific helpers in
            @josui/core-web. Framework packages build on top, so React and Vue can ship the same
            behaviors with idiomatic bindings as the APIs stabilize.
          </p>
          <p>
            <strong>Framework packages and tooling</strong>
            <br />
            React and Vue libraries are published separately, each with Storybook, Vitest, and
            Testing Library setup. The monorepo includes internal linting, TypeScript, and Prettier
            config packages to enforce consistency. It also includes `AGENTS.md` guidance and scoped
            skills to support agentic coding workflows across packages.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="prose">
          ...
          <p>
            ...
            <br />
            The more reliable and automated the tokens become, the more composable and repeatable
            the system gets.
          </p>
          <p>
            <strong>Framework parity must be designed, not assumed.</strong>
            <br />
            The only way to keep APIs consistent over time is to intentionally design the layers
            that sit between core logic and framework bindings.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="prose">
          ...
          <p>
            <strong>Scope:</strong> Multi-package design system with tokens, core utilities,
            framework libraries, and tooling packages (in progress)
          </p>
          <p>
            Repository:{" "}
