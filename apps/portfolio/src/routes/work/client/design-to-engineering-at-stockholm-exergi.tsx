      ...
      <PageSection width="narrow">
        <AnimateContent className="copy">
          ...
          <p className="text-muted-foreground">
            ...
            <br />
            <strong>Outcome:</strong> Design system and frontend infrastructure adopted across
            organization
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            products in Intelligy Solutions — Stockholm Exergi's energy analytics platform.
          </p>
          <p>
            I joined Stockholm Exergi in 2018 as a UX/UI designer. By 2022, the platform had grown
            into multiple products with inconsistent UI and duplicated effort. The unification work
            below is what I led over the final three years.
          </p>
          <p>
            What made the unification work different: our frontend team owned both product design
            and engineering. No handoffs between disciplines, no translation loss. The design system
            we built lives in code — components are the spec.
          </p>
        </AnimateContent>
        ...
        <div className="border-primary-500/30 relative my-8 ml-1.5 space-y-8 border-l-2 pl-8">
          <AnimateContent>
            <TimelineItem
              period="Background (2018–2022)"
              title="Product Design → Frontend Development"
            >
              Joined as UX/UI designer for the customer-facing Intelligy app. Conducted user
              research with property owners and designed data visualization interfaces. Expanded
              into frontend engineering, built features in the Django stack, and led the design and
              development of Intelligy Pro — a React-based platform that eventually absorbed the
              original product.
            </TimelineItem>
          </AnimateContent>
          <AnimateContent>
            <TimelineItem period="2022–2024" title="Architecture & Infrastructure">
              Took ownership of frontend architecture. Built STEXUI — a comprehensive design system
              (60+ components). Created type-safe API tooling with auto-generated TypeScript clients
              from OpenAPI specs. Developed shared utility libraries for formatting, dates, and
              translations.
            </TimelineItem>
          </AnimateContent>
          <AnimateContent>
            <TimelineItem period="2024–2025" title="Standards & Mentorship">
              As the team grew, balanced hands-on development with standards and mentorship. Wrote
              ADRs for API design, led code reviews and feature planning, and enabled developer
              mobility through standardized patterns.
            </TimelineItem>
          </AnimateContent>
        </div>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            directly with internal stakeholders and field users to standardize workflows, establish
            a shared language, and make complex energy data actionable across products.
          </p>
          <p>
            <strong>Core design challenge:</strong> Internal users needed to make decisions quickly.
            The system had to surface the right context without forcing people to interpret raw
            data.
          </p>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            not just shared UI, but shared behavior.
          </p>
          <p>
            <strong>Design System (STEXUI)</strong>
            <br />A comprehensive component and theming system built with React, TypeScript, Radix
            UI primitives, Tailwind CSS, and CVA for type-safe variants. It standardized how
            measurements are formatted, how loading states are rendered, and how optimistic updates
            behave — so the experience felt consistent everywhere.
          </p>
          <p>
          ...
          <p>
            ...
            SDK → TanStack Query Hooks → UI. API integration bugs went from a recurring problem to
            essentially zero.
          ...
          <p>
            ...
            <br />
            Shared utilities for formatting, localization, and common data patterns. Reusable hooks
            and table tooling. A consistent frontend architecture made it easy to spin up new apps
            and keep behavior aligned across codebases. A shared monorepo and tooling standards kept
            packages, configs, and updates centralized.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            UX intent through implementation. That reduced rework and made new patterns usable
            across teams.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            to the new stack, 5 in pipeline at handover.
          </p>
          <p>
          ...
          <p>
            <strong>Quality:</strong> Hard-to-trace bugs became same-day fixes after implementing
            type-safe API clients with Zod validation on all endpoints.
          </p>
          <p>
          ...
          <p>
            <strong>Reusability:</strong> New applications inherited the full component library from
            day one — no rebuilding common patterns.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            <br />
            Every handoff is lossy compression. Owning both sides eliminates the translation layer
            where details get lost.
          </p>
          <p>
            <strong>Design systems are governance problems, not component problems.</strong>
            <br />
            Building a button is easy. Getting eight teams to use the same button — and keep using
            it — is the real work.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            <strong>Scope:</strong> Internal operations products with a shared design system and
