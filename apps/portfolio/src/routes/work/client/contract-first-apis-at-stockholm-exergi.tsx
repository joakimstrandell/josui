      ...
      <PageSection width="narrow">
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            between backend services and frontend applications. By 2024, we needed a faster, safer
            way to evolve APIs without introducing breaking changes or duplicated client code across
            teams.
          </p>
          <p>
            I led the frontend architecture for a contract-first approach: backend and frontend
            defined the API contract together, used that contract as the source of truth, and
            generated type-safe SDKs and query hooks directly from it.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            endpoint, request, and response. From there we automated everything we could.
          </p>
          <p>
            Our workshops started from the UI. We brought user flows and rough mock-ups, walked
            through the screens together, and mapped the data structures needed to power each state.
            We defined the exact endpoints and methods required to create, update, and delete
            content before any implementation started.
          </p>
          <p>
            After the contract was agreed, teams could split and move fast. Frontend generated SDKs
            and mock APIs from the contract, while backend implemented the real services. When the
            mock switched to production, it worked because both sides had built to the same
            contract.
          </p>
          <Checklist
            className="my-4"
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            pipeline when I left.
          </p>
          <p>
            <strong>Contract workflow</strong>
            <br />
            Backend and frontend defined contracts together in Stoplight (SmartBear). The visual
            editor let us build OpenAPI specs without hand-writing YAML, while enforcing shared
            endpoint rules from our best-practices guidelines. The OpenAPI spec was treated as a
            required artifact for every API change.
          </p>
          <p>
            <strong>Generated SDKs</strong>
            <br />
            Kubb generated a typed SDK for each service, producing request/response types, API
            clients, and hooks. This eliminated hand-written API client code and reduced drift
            between contract and usage.
          </p>
          <p>
            <strong>Frontend integration</strong>
            <br />
            TanStack Query hooks standardized loading, caching, and error handling. Zod validators
            provided runtime safety for incoming and outgoing payloads, so posted data matched the
            contract as strictly as responses.
          </p>
        </AnimateContent>
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            out, and shortened the feedback loop between backend and frontend development.
          </p>
          <Checklist
            className="my-4"
            items={[
        ...
        <AnimateContent className="copy">
          ...
          <p>
            ...
            <br />
            The biggest win was not just type safety—it was shared ownership. Writing the contract
            together aligned backend and frontend early, before code diverged.
          </p>
          <p>
            <strong>Generated clients free teams to focus on product work.</strong>
            <br />
            Once the SDKs were in place, teams stopped rebuilding API integrations and moved faster
        ...
        <AnimateContent className="copy">
          ...
          <p>
            <strong>Scope:</strong> Applied across 4+ backend services, with additional services
            queued at the time of handover
          </p>
        </AnimateContent>
